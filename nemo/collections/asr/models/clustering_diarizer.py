...
class ClusteringDiarizer(torch.nn.Module, Model, DiarizationMixin):
    ...
    def _run_vad(self, manifest_file):
        ...
        # change mori hereeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
        # self._vad_out_file = "/home/chita/workstation/NeMo/new_mori/vad_outputs/my_vad.json"
    ...
    def diarize(self, paths2audio_files: List[str] = None, batch_size: int = 0):
        ...
        self._vad_out_file = os.path.join(self._vad_dir, "my_vad.json")
